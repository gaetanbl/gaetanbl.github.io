  ...
  <main class="content-wrapper">
    ...
    <h3>🔌 ROS2 Autonomous</h3>
            ...
            <article class="project-article" id="ia-project-2">
              ...
              <h3>🤖 Duckiebot RL</h3>
              <p>During my R&D internship at Scalian, I developed an end-to-end Reinforcement Learning (RL) pipeline to autonomously guide a physical robot (Duckiebot DB21J) using NVIDIA Isaac Sim, PyTorch (PPO), Docker, and ROS.
              Sim-to-Real Gap & Hardware Calibration: Fine-tuning motor trims, camera distortion, and sensor noise to ensure policies transferred reliably to physical hardware.  </p> 
